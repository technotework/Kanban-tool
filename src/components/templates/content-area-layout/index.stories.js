...
let description = 'import ContentAreaLayout from "@/components/templates/content-area-layout/"';
export default createDefStory("templates/ContentAreaLayout", ContentAreaLayout, description);
